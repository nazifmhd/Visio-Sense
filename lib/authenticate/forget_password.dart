...
class ForgetPassword extends StatelessWidget {
          ...
          Center(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Image.asset(
                    'assets/forgetpassword.jpg', // Placeholder for waveform image
                    height: 200,
                  ),
                  SizedBox(
                    height: 50,
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      FirebaseFirestore.instance
                          .collection('Guardian_User-Data')  // Collection in Firestore
                          .where('Email', isEqualTo: enteredEmail)  // Query for matching email
                          .get()
                        ...
                        if (querySnapshot.docs.isNotEmpty) {
                          ...
                          try {
                            ...
                            print('OTP sent successfully');  // Log success message

                            // Step 4: Navigate to the Verification screen, passing the OTP
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => Verification(otp: otp),  // Pass OTP to Verification screen
                              ),
                            );
                          } catch (error) {
  ...
  String generateOtp() {
    ...
    return (random.nextInt(9000) + 1000).toString();  // Generates a 4-digit OTP (between 1000 and 9999)
  }
